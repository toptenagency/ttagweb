...
const testimonials = [
  ...
  },
  {
    ...
    image:
      "https://amplify-d2jtebj3g0cdpz-ma-amplifydataamplifycodege-o2as8a7qlq7j.s3.amazonaws.com/servicio-fotografia/fotografia-gastronomica-bebida-doctorcito.jpg",
  },
  {
    author: {
      name: "Lindsay Walton",
    ...
    image:
      "https://amplify-d2jtebj3g0cdpz-ma-amplifydataamplifycodege-o2as8a7qlq7j.s3.amazonaws.com/servicio-fotografia/fotografia-gastronomia-boa-sandwich-brisket.jpg",
  },
  {
    author: {
      name: "Tom Cook",
    ...
    image:
      "https://amplify-d2jtebj3g0cdpz-ma-amplifydataamplifycodege-o2as8a7qlq7j.s3.amazonaws.com/servicio-fotografia/fotografia-arquitectura-gran-puerto-cancun.jpg",
  },
  {
    author: {
      ...
      <main>
        ...
        <div className="relative isolate mt-32 sm:mt-56 sm:pt-32">
          ...
          <div className="relative">
            ...
            >
              <div
                className="ml-[-22rem] aspect-[1313/771] w-[82.0625rem] flex-none origin-top-right rotate-[30deg] bg-gradient-to-tr from-audiovisual to-disenoGrafico xl:ml-0 xl:mr-[calc(50%-12rem)]"
                style={{
                  clipPath:
                    "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
                }}
              ...
              <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-sm leading-6 text-gray-100 sm:grid-cols-2 lg:max-w-none lg:grid-cols-3">
                {testimonials.map((testimonial, index) => (
                  <figure className="rounded-2xl bg-white shadow-lg ring-1 ring-gray-900/5">
                    <img
                      src="https://amplify-d2jtebj3g0cdpz-ma-amplifydataamplifycodege-o2as8a7qlq7j.s3.amazonaws.com/servicio-fotografia/fotografia-arquitectura-boa-juegos.jpg"
                      alt="Testimonial"
